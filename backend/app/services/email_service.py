...
<head>
  ...
  <title>SentinelIX Security Verification Code</title>
  <!--[if mso]>
  <noscript>
    <xml>
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;">
                    <div style="font-size:28px;font-weight:900;letter-spacing:-0.5px;line-height:1;">
                      <span style="color:#ffffff;">SENTINEL</span><span style="color:{BRAND_GOLD};">IX</span>
                    </div>
                    <div style="font-size:9px;font-weight:700;letter-spacing:3px;color:rgba(255,255,255,0.5);margin-top:4px;text-transform:uppercase;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#334155;line-height:1.6;">
                Your SentinelIX verification code is:
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                    <div style="display:inline-block;background:linear-gradient(135deg,{BRAND_NAVY} 0%,{BRAND_NAVY_LIGHT} 100%);border-radius:12px;padding:22px 52px;margin:0 auto;border:2px solid rgba(224,168,46,0.2);">
          ...
          <tr>
            <td style="background-color:{BRAND_BG};padding:24px 40px;border-top:1px solid #e2e8f0;">
              <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.5;text-align:center;">
                Best Regards,<br />
                <strong style="color:{BRAND_NAVY};">SentinelIX Security Team</strong>
              </p>
              <p style="margin:12px 0 0;font-size:11px;color:#cbd5e1;line-height:1.5;text-align:center;">
                This is an automated message from SentinelIX Vulnerability Intelligence Platform.
...
def _build_otp_text(code: str, username: str) -> str:
    ...
    return (
        f"SentinelIX Security Verification Code\n"
        f"{'=' * 40}\n\n"
        f"Dear {username},\n\n"
        f"Your SentinelIX verification code is:\n\n"
        f"    {code}\n\n"
        f"This code will expire in 15 minutes.\n\n"
        f"If you did not request this login, please ignore this email\n"
        f"or contact our security team immediately.\n\n"
        f"Best Regards,\n"
        f"SentinelIX Security Team\n"
    )
...
async def send_otp_email(to_email: str, code: str, username: str) -> None:
    ...
    subject = "SentinelIX Security Verification Code"
    ...
    from_addr = (settings.smtp_from or settings.smtp_user or "noreply@sentinelix.local").strip()
